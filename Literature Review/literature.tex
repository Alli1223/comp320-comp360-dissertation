...
\section{Literature Review}
	...
	\subsection{Game Search Techniques}
		...
		\subsubsection{Evolutionary Algorithms} \label{sssec:EA}
			...
			The term Rolling Horizon comes from the fact  that the planning happens until a limited look-ahead in the game (the horizon) \cite{gaina2017analysis, gaina2017rolling}.
