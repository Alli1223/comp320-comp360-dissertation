...
\section{Literature Review}
	...
	\subsection{The General Video Game AI Competition}
		...
		\begin{figure}[h]
		    ...
		    \caption{angelsdemons, butterflies, pacman, . Image sourced from \cite{gaina2016general}. }
		    \label{fig:VGDL}
		\end{figure}
		%VGDL
	...
	\subsection{Game Search Techniques}
		...
		\subsubsection{Evolutionary Algorithms} \label{sssec:EA}
			...
			Perez et al. in \cite{perez2013rolling} compared MCTS with RHEA on the Physical Traveling Salesman Problem (PTSP) and their results show that RHEA is a promising competitor to MCTS.
			...
			Evolutionary algorithms are often used 
			The figure \ref{RHEArollout} shows the steps of RHEA, 
