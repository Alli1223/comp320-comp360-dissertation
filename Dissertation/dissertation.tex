...
% Testing of search algorithms
	\subsection{Testing of tree search algorithms}
		Running G*Power with a Effect size of 0.05 and a type I error rate of 0.05, and type II error rate of 95\% the sample size for each game is 4331. To round this off each game was ran 5000 times.  
