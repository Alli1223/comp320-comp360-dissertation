...
\todo[inline]{Refactor hypothesis}
	...
	\textbf{Null Hypothesis:}
		MCTS has a lower win rate compared to other tree search algorithms in this paper on large maps
...
%%%%%%%%%%% Requirements analysis and specification %%%%%%%%%%%%%%%%%%%%%%%
	...
	% calcuating amount of tests to be run
		...
		%\begin{figure}[h]
		   % \centering
		    %\includegraphics[width=0.5\textwidth]{GPower}
		    %\caption{ Sample size calculated with G * Power }
		    %\label{fig:GPower}
		%\end{figure}
		...
		\begin{figure}[h]
		    ...
		    \label{fig:GPower}
		\end{figure}
		\todo[inline]{Re-do this graph with actual game data}
