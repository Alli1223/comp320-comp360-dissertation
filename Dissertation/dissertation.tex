...
\section{Introduction}
	\IEEEPARstart{T}{his} paper compares tree search techniques used within the General Video Game Artificial Intelligence (GVG-AI) competition.  
...
\todo[inline]{Add finding and resutls here, as well as contribution}
...
% 1 MCTS has a higher  win rate compared to other tree search algorithms in this paper on large maps
% 2 (NULL) MCTS has a lower  win rate compared to other tree search algorithms in this paper on large maps
% 3 MCTS has a higher  win rate compared to other tree search algorithms in this paper on small maps
% 4 (NULL) MCTS has a lower  win rate compared to other tree search algorithms in this paper on small maps

% 1 BrFS has a higher  win rate compared to other tree search algorithms in this paper on large maps
% 2 (NULL) BrFS has a lower  win rate compared to other tree search algorithms in this paper on large maps
% 3 BrFS has a higher  win rate compared to other tree search algorithms in this paper on small maps
% 4 (NULL) BrFS has a lower  win rate compared to other tree search algorithms in this paper on small maps

% 1 BeFS has a higher  win rate compared to other tree search algorithms in this paper on large maps
% 2 (NULL) BeFS has a lower  win rate compared to other tree search algorithms in this paper on large maps
% 3 BeFS has a higher  win rate compared to other tree search algorithms in this paper on small maps
% 4 (NULL) BeFS has a lower  win rate compared to other tree search algorithms in this paper on small maps


% correlation between map size and tree search performance
% BeFS's performance increases with larger levels
% MCTS's performance increases 
% BrFS's performance increases with larger levels


% Reasearch question I aim to answer:
% How well do different tree search techniques scale within the gvg-ai framework
% Can 

% Map size decreases the performance of 
% BeFS performs better in smaller maps



\subsection{Hypothesis}
\todo[inline]{Refactor hypothesis}

	\textbf{Hypothesis One:}
		MCTS has a higher win rate compared to BrFS and BeFS on larger deterministic games
	\textbf{Null Hypothesis:}
		MCTS has a lower win rate compared to BrFS and BeFS on larger deterministic games
...
\subsection{Research philosophy}
	...
	% Posivitism
	% collect data -> Test hypothesis based on statistical analysis of data -> Confirm or reject hypothesis
...
%%%%%%%%%%% Requirements analysis and specification %%%%%%%%%%%%%%%%%%%%%%%
	...
	The computer used to carry out the simulations had Intel(R) Xeon(R) CPU E5-2650 v4 @ 2.20GHz - 128GB RAM, 1.1TB SSD.
	...
	% calcuating amount of tests to be run
...
%%%%%%%%%%% Design  and Implementation of research artifact %%%%%%%%%%%%%%%%%%%%%%%
% DESIGN
	...
	% Development of json-csv converter
...
% IMPLEMENTATION
 % Used the Incremental Model for the development of the software artefacet
	\subsection{Chosen Development Life Cycle}
		The software artifact for this project was developed using the agile aproach to software developement \cite{beck2001manifesto, cockburn2001agile, dybaa2008empirical}, this is a method of software development where the software is developed incrementally, in small iterations.
...
%%%%%%%%%%% Method of evaluation the research artifact (Unit Testing) and results %%%%%%%%%%%%%%%%%%%%%%%
...
\section{Results}
	...
	%Analysis of image
		Figure \ref{allGameBarPlot} shows the win percentage of all the games being tested, this shows that all the different tree search techniques generally stuggle with similar games, of which are both deterministic and stochastic games.
In this graph, only the first level of each game was tested.

	One notable finding is how well the random controller did in both infection and modality games, with a > 50 \% winrate on those games. This may show that those games may be not too challenging for the controllers.



	All the graphs were compiled using R, 
	% R code
	\begin{figure}[h]
		    \centering
		    \includegraphics[width=0.5\textwidth]{croppedR1}
		    \caption{ R for loading games}
		    \label{fig:croppedR1}
		\end{figure}
...
%%%%%%%%%%% Professional Considerations  & Acknowledgements %%%%%%%%%%%%%%%%%%%%%%%

\section{Future Work}

The experiments in this paper only used 20 of the games in the competition, not just 82 games currently in the competition, so comparing all the games in the competition may lead to a better understanding. % Finish
