...
%%%%%%%%%%% Requirements analysis and specification %%%%%%%%%%%%%%%%%%%%%%%
	...
	\textbf{Sample Flat MCTS}

	\textbf{Sample Open Loop MCTS}
...
% IMPLEMENTATION
 % Used the Incremental Model for the development of the software artefacet
	\subsection{Chosen Development Life Cycle}
		The software artifact for this project was developed using the agile approach to software developement \cite{beck2001manifesto, cockburn2001agile, dybaa2008empirical}, this is a method of software development where the software is developed incrementally, in small iterations.
...
\section{Results}
		...
		\begin{figure}[h]
			...
			%\incgraph[overlay={\node[red] at (page.center) {\Huge Picture sized to paper};}][width=\paperwidth,height=\paperheight {allGameBarPlot}
	%\makebox[\linewidth*2]{ \includegraphics[width=2\linewidth]{allGameBarPlot}}
...
In this graph, only the first level of each game was tested.
	...
	All the graphs were compiled using R, figure \ref{croppedR1} shows how the large data sets were loaded into R.
	% R code
	\begin{figure}[h]
		    \centering
