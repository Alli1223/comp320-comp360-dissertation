...
% Testing of search algorithms
	\subsection{Testing of tree search algorithms}
		...
		From the selection of 20 games, when each game was simulated 5000 times, and with the 5 different tree search algorithms being tested, each run of the competition ran roughly 500,000 games. $ 20 \cdot 5000 \cdot 5  = 500,000$
