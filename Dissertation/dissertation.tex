...
%%%%%%%%%%% Requirements analysis and specification %%%%%%%%%%%%%%%%%%%%%%%
	...
	For carrying out the research on the gvg-AI competition, IntelliJ IDEA 2017.3 was used. RStudio Version 1.1.419. The simulations were copiled and executed with java jdk 9, and simulated on ubuntu 16.04.
	Pycharm 2018.1.2 was used to create the simulation launcher.
	
	%PC Specs for simulations
	The computer used to carry out the simulations had Intel C2750 (8 Core @ 2.4GHz), 16GB RAM, 1TB HDD.
	\todo[inline]{Add specs for studio PCs}
	...
	% calcuating amount of tests to be run
		...
		\begin{figure}[h]
		    \centering
		    \includegraphics[width=0.5\textwidth]{Rplot(meansSD)}
		    \caption{ Means of all games }
		    \label{fig:GPower}
		\end{figure}
		
		From the selection of 20 games, when each game was simulated 5000 times, and each game has 5 levels, with the 3 different tree search algorithms being tested, each run of the competition ran roughly 500,000 games. 
...
The experements in this paper only used 20 of the games in the competition, not just 82 games currently in the competition, so comparing all the games in the competition may lead to a better understanding. % Finish
