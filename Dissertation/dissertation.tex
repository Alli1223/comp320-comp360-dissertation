...
\subsection{Hypothesis}
	\textbf{Hypothesis One:}
		MCTS has a higher win rate compared to BrFS and BeFS as map size increases in deterministic games % FALSE  -  bait - false (BeFS & BrFSE > MCTS & OLMCTS), hungry birds - false, modality - false

	\textbf{Hypothesis Two:}
		MCTS has a higher win rate compared to BrFS and BeFS as map size increases in stochastic games % TRUE

	\textbf{Hypothesis Three:}
		BrFS has a higher win rate compared to MCTS and BeFS as map size increases in deterministic games % TRUE

	\textbf{Hypothesis Four:}
		BrFS has a higher win rate compared to MCTS and BeFS as map size increases in stochastic games % FALSE
		
	\textbf{Hypothesis Five:}
		BeFS has a higher win rate compared to  MCTS and BrFS as map size increases in deterministic games % FALSE - but > MCTS

	\textbf{Hypothesis Six:}
		BeFS has a higher win rate compared to  MCTS and BrFS as map size increases in stochastic games % FALSE
