...
\subsection{Hypothesis}
	...
	\textbf{Hypothesis One:}
		MCTS modification A will prove better than MCTS modification B
		
	\textbf{Hypothesis Two:}
		MCTS modification B will prove better than MCTS modification A
...
\section{Experimental Work}
	...
	The PC used to carry out the simulations had... % FILL OUT WHEN DONE
...
%%%%%%%%%%% Design of research artifact %%%%%%%%%%%%%%%%%%%%%%%
	...
	One of the big limitations for the sampleMCTS agent within GVG-AI is it's locality limitation, which was...
