...
\todo[inline]{Refactory hypothesis}
	...
	\todo{Research philosophy}
	When researching a positivist approach \cite{scientific-method, crossan2003research} was taken to this project, meaning 
...
%%%%%%%%%%% Requirements analysis and specification %%%%%%%%%%%%%%%%%%%%%%%
	...
	% calcuating amount of tests to be run
		...
		From the selection of 20 games, when each game was simulated 5000 times, and with the 5 different tree search algorithms being tested, each run of the competition ran roughly 500,000 games. 
