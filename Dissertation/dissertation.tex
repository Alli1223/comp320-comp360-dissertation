...
This tree search method was used because it is one of the most basic tree search algorithms, as it ecentially brute-force searches the tree, and can be used as a benchmark for the other tree searching algorithms. In this paper, breadth first search starts a new tree search from 
...
% IMPLEMENTATION
 % Used the Incremental Model for the development of the software artefacet
	\subsection{Chosen Development Life Cycle}
		The software artifact for this project was developed using the agile approach to software development \cite{beck2001manifesto, cockburn2001agile, dybaa2008empirical}, this is a method of software development where the software is developed and tested incrementally, in small iterations.





	% visualisation of tree search
	\begin{figure}[h]
		   \centering
