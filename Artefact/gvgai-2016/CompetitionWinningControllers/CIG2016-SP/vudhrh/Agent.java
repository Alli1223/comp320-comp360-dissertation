...
public class Agent extends AbstractPlayer {
    ...
    public static int ROLLOUT_DEPTH = 6;
     ...
     */
    private VudhrhMCTSPlayer mctsPlayer;
    ...
    public Agent(StateObservation so, ElapsedCpuTimer elapsedTimer)
    {
        ...
        //Create the player.
        mctsPlayer = new VudhrhMCTSPlayer(new Random());
    }
    ...
    public Types.ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
        ...
        if(Agent.NUM_ACTIONS != 4 && action == 0){
        	
        }else
        	m.push(action,stateObs);
        //... and return it.
